              ...
              <Card className="glass border-border/50 animate-fade-in">
                ...
                <CardContent>
                  <p className="text-lg leading-relaxed">
                    Remzona54 начала свою работу как небольшая мастерская для энтузиастов мотоциклов.
                    Наша страсть к японской мототехнике и стремление предоставлять качественный сервис
                    быстро завоевали доверие клиентов в регионе.
                  </p>
                </CardContent>
              </Card>
